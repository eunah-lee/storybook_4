...
function initialize()
{
  ...
  //init renderer
	renderer = new THREE.WebGLRenderer({
     ...
     renderer.domElement.style.background = "url('https://cdn.glitch.com/ec15ea37-fcdc-404d-b098-cb501a805a16%2Fscene3-boatBackground.png?v=1590430691172'), url('https://cdn.glitch.com/ec15ea37-fcdc-404d-b098-cb501a805a16%2Fscene3-wave-loop.gif?v=1590431004232'), url('https://cdn.glitch.com/ec15ea37-fcdc-404d-b098-cb501a805a16%2Fscene3-background.png?v=1590430687026')";
...
//marker and graphic
  ...
  let geometry1 = new THREE.PlaneGeometry(2, 2, 2);
    ...
    //adding the fisrt image - flag
	   let texture1 = loader.load( 'https://cdn.glitch.com/ec15ea37-fcdc-404d-b098-cb501a805a16%2Fscene3-flag.png?v=1590430209883', render ); 
